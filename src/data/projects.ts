...
export function getProjectBySlug(slug: string): Project | null {
  return [...clientProjects, ...personalProjects].find((p) => p.slug === slug) || null;
}

export function getAllProjectSlugs(): string[] {
  return [...clientProjects, ...personalProjects].map((p) => p.slug);
}
